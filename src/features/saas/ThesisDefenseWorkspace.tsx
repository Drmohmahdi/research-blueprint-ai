        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-md text-caption font-black bg-[var(--ds-success-soft)] border border-[var(--ds-success)]/30 text-[var(--ds-success)] tracking-wider">
