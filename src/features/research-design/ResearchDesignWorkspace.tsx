...
export const ResearchDesignWorkspace: React.FC = () => {
  ...
  if (!activeProject) {
    return (
      <EmptyActiveProject
        language={language}
        description={language === 'ar' ? 'أنشئ مشروعًا من اختيار المسار لفتح مساحة تصميم الدراسة.' : 'Create a project from path selection to open the study design workspace.'}
      />
    );
  }
