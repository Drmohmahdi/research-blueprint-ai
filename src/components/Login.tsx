...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-zinc-950 text-zinc-100 font-sans select-none px-4 py-12">
      
      {/* ── Dynamic Gradient Mesh Background ── */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[30%] -right-[20%] w-[80vw] h-[80vw] rounded-full bg-gradient-to-br from-purple-800/15 via-indigo-900/5 to-transparent blur-[120px] animate-pulse duration-10000" />
        <div className="absolute -bottom-[20%] -left-[20%] w-[70vw] h-[70vw] rounded-full bg-gradient-to-tr from-emerald-800/10 via-purple-900/5 to-transparent blur-[120px] animate-pulse duration-7000" />
        <div className="absolute top-[40%] left-[30%] w-[30vw] h-[30vw] rounded-full bg-indigo-600/5 blur-[80px] animate-pulse duration-5000" />
      </div>
      ...
      <div className="absolute top-6 left-6 right-6 z-20 flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-black tracking-widest bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-300">
            BASEERAH V2
          </span>
        </div>
      ...
      <div className="w-full max-w-4xl z-10 space-y-6 animate-fade-in">
        ...
        {/* Main Content Layout */}
        <Card className="backdrop-blur-xl bg-zinc-900/60 border border-zinc-800/80 shadow-[0_0_50px_rgba(168,85,247,0.15)] rounded-[32px] overflow-hidden grid grid-cols-1 lg:grid-cols-12">
          
          {/* Left Column: Welcome and Info Graphic (Desktop Only) */}
          <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-purple-900/50 via-indigo-950/40 to-zinc-950 p-8 flex-col justify-between border-r border-zinc-800/40 relative">
            <div className="absolute top-0 right-0 p-4 opacity-5 pointer-events-none">
              <Sparkles size={160} />
            </div>
            
            <div className="space-y-4 relative z-10">
              <span className="px-2.5 py-1 rounded-md text-[9px] font-black bg-purple-500/20 border border-purple-400/30 text-purple-300 tracking-wider uppercase">
                {language === 'ar' ? 'النسخة الثانية V2' : 'Version 2.0'}
              </span>
            ...
            <div className="my-8 flex justify-center items-center">
              <svg className="w-48 h-48 drop-shadow-[0_0_15px_rgba(168,85,247,0.25)]" viewBox="0 0 200 200" fill="none">
                ...
                <path d="M70 100 H130 M100 70 V130" stroke="var(--ds-color-primary, #a855f7)" strokeWidth="0.5" strokeOpacity="0.5" />
                
                {/* Floating Node dots */}
                <circle cx="70" cy="100" r="4" fill="#a855f7" className="animate-bounce" />
                <circle cx="130" cy="100" r="4" fill="#6366f1" className="animate-ping" />
          ...
          <div className="lg:col-span-7 p-6 md:p-8 flex flex-col justify-between space-y-6">
                    ...
                    return (
                      <button
                        ...
                        className={`text-right flex flex-col justify-between p-3.5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden group bg-zinc-900/60 ${
                          isSelected 
                            ? `border-purple-500/70 shadow-lg ${roleItem.shadow} scale-[1.02]`
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-xl py-2.5 pr-10 pl-4 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-purple-500/50 text-white placeholder-zinc-600"
                  />
                </div>
              </div>
            ...
            <div className="text-center pt-4 border-t border-zinc-800/40">
              <button
                ...
                className="text-purple-400 hover:text-purple-300 hover:underline text-xs font-black bg-transparent border-none cursor-pointer"
              >
                {authMode === 'login' 
